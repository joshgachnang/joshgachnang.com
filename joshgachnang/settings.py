# Django settings for joshgachnang project.
import os.path
import posixpath
...
SECRET_KEY = '_3pkd%eli1y6veuy3j(dvq170jk-nmxe$w=c25hi@)9a633(-x'
...
ROOT_URLCONF = 'joshgachnang.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'joshgachnang.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = DEFAULT_SETTINGS.TEMPLATE_CONTEXT_PROCESSORS + (
    'joshgachnang.global_site_context.site_context',
)
